...
app = FastAPI(title="QuickServe API Gateway", description="Passerelle API pour les microservices QuickServe")
...
# Client HTTP pour les requêtes aux microservices
...
async def proxy_request(request: Request, service: str, path: str):
    ...
    try:
        # Envoi de la requête au microservice
